 ...
 * @property {string} url - URL of the attachment, defaults to an empty string.
 ...
 * @property {string} uid - The unique identifier string for the agent.
 * @property {number} idUser - The ID of the user associated with the agent.
 * @property {string} name - The name of the agent.
 * @property {string} description - The description of the agent.
 * @property {string} status - The status of the agent.
 * @property {Object} [metas] - Additional metadata for the agent.
 * @property {Date} created - The date and time when the agent was created.
 * @property {Date} modified - The date and time when the agent was last modified.
 */